...
export default function PostCard({ post, onEdit, onDiscard }: PostCardProps) {
  ...
  return (
    ...
    >
      ...
      <button className="text-sm text-white hover:text-[#cfe2dc] md:text-base font-bold py-2 md:py-3">
        Schedule
      </button>
